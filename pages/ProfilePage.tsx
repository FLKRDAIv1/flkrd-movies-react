        ...
        return (
            <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-20">
                ...
                <motion.div 
                    ...
                    className="w-full max-w-[430px] bg-black/25 backdrop-blur-[4px] border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-[0_40px_80px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] relative overflow-hidden flex flex-col min-h-[560px]"
                >
                    {/* Back Button Pill */}
                    <button
                        onClick={() => navigate(-1)}
