...
#ifndef FLKRD_MOVIES_SWIFT_H
#define FLKRD_MOVIES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FLKRD_MOVIES",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC12FLKRD_MOVIES22PlayerWindowController")
